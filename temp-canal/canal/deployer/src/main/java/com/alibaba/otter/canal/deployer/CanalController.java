...
public class CanalController {
    ...
    // 默认使用spring的方式载入，<instanceName,InstanceConfig>
    ...
    private void otherSettingInit(Properties properties){
        // init socketChannel
     ...
     * @Date: 2020/6/9
     */
    private Map initRunningMonitors(final ServerRunningData serverData){
        return MigrateMap.makeComputingMap(new Function<String, ServerRunningMonitor>() {
                ...
                runningMonitor.setListener(new ServerRunningListener() {
                    ...
                    public void processActiveEnter() {
                        try {
                            ...
                            //- SpringCanalInstanceGenerator.generate() ，加载spring文件
    ...
    /****
     * @Description: TODO-ZL 自动扫描相关
     * @Param: [properties]
     * @return: void
     * @Author: zhanglei
     * @Date: 2020/6/9
     */
    private void initAutoScan(Properties properties){
    ...
    public CanalController(final Properties properties){
        ...
        //- 全局的配置用来兜底，各个instance的配置对global是覆盖关系canal.instance.{instanceName}
        //- 初始化全局参数设置 prefix=canal.instance.global
        ...
        //- 其他的一些setting
        otherSettingInit(properties);


        //- 初始化实例目录&cluster目录 /otter/canal/destinations & /otter/canal/cluster
        ...
        ServerRunningMonitors.setRunningMonitors(initRunningMonitors(serverData));


        //- 自动扫描相关
        initAutoScan(properties);
    ...
    /***
     * @Description: 创建zk集群目录
     * @Param: []
     * @return: void
     * @Author: zhanglei
     * @Date: 2020/6/9
     */
    private void createZkClusterPath(){
        //- path = /otter/canal/cluster/192.168.81.42:11113 创建集群目录
